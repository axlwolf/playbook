...
const carloStudent = new Student("Axel", 12, ["NodeJs", "Python"])
...
const myRepo = new Repository("LaunchX", "axlwolf", "js", 100)
...
const axlwolfDev = new Developer("Axel", "js", ["elixir", "groovy", "lisp"])
console.log(axlwolfDev)
...
const axlwolfLaunchXDev = new LaunchXStudent("Axel", "js", ["elixir", "groovy", "lisp"])
console.log(axlwolfLaunchXDev)
console.log(axlwolfLaunchXDev.getName) // getter de la clase padre rehusada en la clase hija
...
const viajero1 = new Viajero("Axel", "LaunchX", "Node JS", "Abril 2022")
